...
<%@page import="com.min.edu.dto.Paging_Dto"%>
...
<script type="text/javascript">
	...
	function writeForm() {
		//	alert("a");
		//	location.href="./write.do?selEtc=F"+"&seq=151";
...
// 	function delflag() {
// 		location.href = "./delflag.do?selEtc=F";
// 	}
	
	function goPage(pageNo){
		document.listForm.pageNo.value = pageNo;
		document.listForm.selEtc.value = "F";
...
<div class="container">
	...
	<div class="panel-group" id="accordion">
				<input type="hidden" name="selEtc" id="selEtc" value="F" onload="selView()">
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					...
					&& (Integer.toString(udto.getU_auth().trim().compareToIgnoreCase("U")) != "A")){ 
					%>
					<td style="color: red; font: 0.1em; text-align: center;" colspan="8">- 삭제된 글 입니다 -</td> 
<				<c:if test="${user.u_auth eq 'A'}">
					</c:if>  --%>
		...
		<!-- 페이징 -->
		<form name="listForm" action="./freeboard.do" method="get" style="position: relative; left: 770px; top: 180px;  z-index: -1;">
			<input type="hidden" name="pageNo" value="" />
			<input type="hidden" name="selEtc" value="F" /><br/><br/>
	...
	<form name="form1" action="./freeboard.do" method="get" style="position: relative; left: 750px; top :180px;">
	...
	<input type="button" id="Nwrite" class="btn btn-primary" value="새글작성" onclick="writeForm()" style="position: absolute; left: 1100px; top :490px;">
	<input type="button" id="main" class="btn btn-info" value="메인으로 가기" onclick="main()" style="position: absolute; left: 1200px; top :490px;">
